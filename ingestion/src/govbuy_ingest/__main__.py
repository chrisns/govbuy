...
def main(argv: list[str] | None = None) -> int:
    ...
    sub.add_parser("modern-slavery-sync"); sub.add_parser("buyer-classification-sync")
    ...
    if args.mode == "modern-slavery-sync":
        from . import open_refs
        print(json.dumps(open_refs.modern_slavery_sync(), indent=2, default=str)); return 0
    if args.mode == "buyer-classification-sync":
        from . import open_refs
        print(json.dumps(open_refs.buyer_classification_sync(), indent=2, default=str)); return 0
